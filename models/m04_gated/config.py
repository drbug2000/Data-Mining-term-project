...
class GateConfig:
    ...
    f1_fit_max_rows: int = 2000
    """내부-val 에서 F1 지수 좌표상승을 적합할 때 사용할 최대 샘플 수.
    0 이하면 전체 내부-val 을 사용한다."""

    f1_fit_grid_step: float = 0.5
    """F1 지수 좌표상승 grid step."""

    f1_fit_passes: int = 4
    """F1 지수 좌표상승 최대 pass 수."""
